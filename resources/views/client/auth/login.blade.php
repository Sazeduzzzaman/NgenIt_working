    ...
    <section class="container">
        <div class="row mt-5 mb-5">
            <div class="col-lg-12 d-flex justify-content-center">
                <h3 class="main_color">Login / Register</h3>
            </div>
        </div>
    </section>
    <section class="container">
                ...
                <div class="main">
                    ...
                    <div class="signup" style="margin-bottom: 10px !important;">
                        <form action="{{ route('clientRegister.store') }}" method="POST">
                            @csrf
                            <label class="sign_up_btn" for="chk" aria-hidden="true">Sign up</label>
                            <p class="text-center p-0 m-0"><span class="text-black">Already Have an Account ?</span></p>
                            <label class="sign_back" for="chk" aria-hidden="true">Login Now</label>
                            <input class="input_login" type="text" name="name" placeholder="Full name" required value="{{old('name')}}">
                            <input class="input_login" type="email" name="email" placeholder="Email" required value="{{old('email')}}">
                            <input class="input_login" type="number" name="phone" placeholder="Phone" required value="{{old('phone')}}">
                            <input class="input_login" type="password" name="password" placeholder="Password" required value="{{old('password')}}">
                            <input class="input_login" type="password" name="password_confirmation" placeholder="Confirm Password" required>
                            <div class="">
                    ...
                    <div class="login">
                        <form id="myform" action="{{ route('client.loginstore') }}" method="POST" style="margin-top: 3rem !important;">
                            ...
                            <label class="sign_back" for="chk" aria-hidden="true">Sign Up Now</label>
