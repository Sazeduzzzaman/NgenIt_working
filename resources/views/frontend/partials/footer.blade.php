            ...
            <div class="col-lg-6 col-md-6 col-sm-12 footer_item_wrapper">
              ...
              <form class="p-0 m-0" id="myform" action="{{route('newsletter.store')}}" method="post" enctype="multipart/form-data">
                <div class="input-group w-75">
                  <input type="email" class="form-control" placeholder="Enter your email" style="height: 37px;">
  ...
  <section>
    <div id="feedback_Sidebar" class="feedbacksidebar">
      <div class="feedback_header_logo">
        <button class="close_feedback" onclick="feedbackButtonClicked()">
      ...
      <div id="feedback" class="feedback_details">
        <p>Thank you for assisting us with your feedback in this quick survey. Please take a minute to answer the questions below regarding your experience. <br>
          <br> If you are experiencing an issue with your account, orders, or billing and want immediate assistance, please use our chat feature.
        </p>
      ...
      <div id="feedback_details" class="feedback_details" style="display: none;">
        ...
        <div class="checkbox_wrapper">
          <label class="feedback_details_checkbox">Product Details and availability <input type="checkbox" checked="checked">
            <span class="checkmark_feedback"></span>
          </label>
        </div>
        <!--Check Box item-->
        <div class="checkbox_wrapper">
          <label class="feedback_details_checkbox">Articles, reports, & blog content <input type="checkbox" checked="checked">
            <span class="checkmark_feedback"></span>
          </label>
        </div>
        <!--Check Box item-->
        <div class="checkbox_wrapper">
          <label class="feedback_details_checkbox">Purchasing, checkout & cart <input type="checkbox" checked="checked">
            <span class="checkmark_feedback"></span>
          </label>
        </div>
        <!--Check Box item-->
        <div class="checkbox_wrapper">
          <label class="feedback_details_checkbox">Pricing <input type="checkbox" checked="checked">
            <span class="checkmark_feedback"></span>
          </label>
        </div>
        <!--Check Box item-->
        <div class="checkbox_wrapper">
          <label class="feedback_details_checkbox">Solutions & services content <input type="checkbox" checked="checked">
            <span class="checkmark_feedback"></span>
          </label>
        </div>
        <!--Check Box item-->
        <div class="checkbox_wrapper">
          <label class="feedback_details_checkbox">Product search <input type="checkbox" checked="checked">
            <span class="checkmark_feedback"></span>
          </label>
        </div>
        ...
        <div class="d-flex justify-content-between m-2">
          <button class="feedback_continue_btn" onclick="feedbackVisible();" value="Click">
            <i class="fa-solid fa-chevron-left"></i> previous </button>
          <button class="feedback_continue_btn" onclick="feedbackVisible();" value="Click">continue <i class="fa-solid fa-chevron-right"></i>
          </button>
        </div>
      </div>
    </div>
    <div id="feedback_btn">
      <button id="sidebarButton_fb" class="openbtnfeedback" onclick="feedbackButtonClicked()">
        <i class="fa-solid fa-bullhorn"></i> Feedback </button>
    </div>
  </section>
  <!----------End--------->
