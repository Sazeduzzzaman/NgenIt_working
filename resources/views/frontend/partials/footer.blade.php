    ...
    <div id="feedback_Sidebar" class="feedbacksidebar">
        ...
        <div id="feedback" class="feedback_details">
            <p>Thank you for assisting us with your feedback in this quick survey. Please take a minute to answer the
                ...
                <br> If you are experiencing an issue with your account, orders, or billing and want immediate
                assistance, please use our chat feature.
            </p>
        ...
        <div id="feedback_details" class="feedback_details" style="display: none;">
            ...
            <div class="checkbox_wrapper">
                <label class="feedback_details_checkbox">Product Details and availability <input type="checkbox"
                        checked="checked">
            ...
            <!--Check Box item-->
            <div class="checkbox_wrapper">
                <label class="feedback_details_checkbox">Articles, reports, & blog content <input type="checkbox"
                        checked="checked">
                    <span class="checkmark_feedback"></span>
                </label>
            </div>
            <!--Check Box item-->
            <div class="checkbox_wrapper">
                <label class="feedback_details_checkbox">Purchasing, checkout & cart <input type="checkbox"
                        checked="checked">
                    <span class="checkmark_feedback"></span>
                </label>
            </div>
            ...
            <!--Check Box item-->
            <div class="checkbox_wrapper">
                <label class="feedback_details_checkbox">Solutions & services content <input type="checkbox"
                        checked="checked">
                    <span class="checkmark_feedback"></span>
                </label>
            </div>
