                        ...
                        <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="tab_side_image p-5">
                                            <img src="{{asset('storage/'.$story1->image)}}" style="height:200px;width:280px;"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="col-lg-8 col-md-6 col-sm-12">
                                        <h5 class="home_title_heading" style="text-align: left;">{{$story1->badge}} </h5>
                                        <h4 style="text-align: left;">{{$story1->title}} </h4>
                                        <p class="mb-1">{{$story1->header}}</p>
                                        <p>{!! Str::limit($story1->short_des, 200) !!}......</p>
                                        <a href="{{route('blog.details',$story1->id)}}" class="common_button2">Read Details</a>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="tab_side_image p-5">
                                            <img src="{{asset('storage/'.$story2->image)}}" style="height:200px;width:280px;"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="col-lg-8 col-md-6 col-sm-12">
                                        <h5 class="home_title_heading" style="text-align: left;">{{$story2->badge}} </h5>
                                        <h4 style="text-align: left;">{{$story2->title}} </h4>
                                        <p class="mb-1">{{$story2->header}}</p>
                                        <p>{!! Str::limit($story2->short_des, 200) !!}......</p>
                                        <a href="{{route('blog.details',$story2->id)}}" class="common_button2">Read Details</a>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="tab_side_image p-5">
                                            <img src="{{asset('storage/'.$story3->image)}}" style="height:200px;width:280px;" alt="">
                                        </div>
                                    </div>
                                    <div class="col-lg-8 col-md-6 col-sm-12">
                                        <h5 class="home_title_heading" style="text-align: left;">{{$story3->badge}} </h5>
                                        <h4 style="text-align: left;">{{$story3->title}} </h4>
                                        <p class="mb-1">{{$story3->header}}</p>
                                        <p>{!! Str::limit($story3->short_des, 200) !!}......</p>
                                        <a href="{{route('story.details',$story3->id)}}" class="common_button2">Read Details</a>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="nav-about" role="tabpanel" aria-labelledby="nav-about-tab">
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="tab_side_image p-5">
                                            <img src="{{asset('storage/'.$story4->image)}}" style="height:200px;width:280px;" alt="">
                                        </div>
                                    </div>
                                    <div class="col-lg-8 col-md-6 col-sm-12">
                                        <h5 class="home_title_heading" style="text-align: left;">{{$story4->badge}} </h5>
                                        <h4 style="text-align: left;">{{$story4->title}} </h4>
                                        <p class="mb-1">{{$story4->header}}</p>
                                        <p>{!! Str::limit($story4->short_des, 200) !!}......</p>
                                        <a href="{{route('story.details',$story4->id)}}" class="common_button2">Read Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
