                    ...
                    <div class="card card-block">
                        ...
                        <div class="px-3 py-3 d-flex flex-column justify-content-center">
                            ...
                            <div class="row d-flex">
                                <div class="col">
                                    <i class="fa-solid fa-user-tie"></i>Vacancy <br> <span
                                        class="text-danger">{{ $item->experience }}</span>
                                </div>
                                <div class="col">
                                    <i class="fa-solid fa-calendar-day"></i> Deadline <span
                                        class="text-danger">{{ $item->deadline }}</span>
                                </div>
                            </div>
                            <button type="submit" class="common_button effect01 mt-2" tabindex="-1">Learn More</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
