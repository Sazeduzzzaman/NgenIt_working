                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="box shadow-lg rounded">
                            <img class="img-fluid" src="{{asset('frontend/images/Frame 4 (4).jpg')}}" style=" height: 300px;">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="box shadow-lg rounded">
                            <img class="img-fluid" src="{{asset('frontend/images/Frame 4 (5).jpg')}}" style=" height: 300px;">
                            <div class="box-content">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="box shadow-lg rounded">
                            <img class="img-fluid" src="{{asset('frontend/images/Frame 4 (6).jpg')}}" style=" height: 300px;">
                            <div class="box-content">
                  ...
                  <div class="col-xs-12 ">
                    <nav>
                      <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-healthcare" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">{{$story1->badge}}</a>
                        <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">{{$story2->badge}}</a>
                        <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">{{$story3->badge}}</a>
                      </div>
                    </nav>
                    @php
