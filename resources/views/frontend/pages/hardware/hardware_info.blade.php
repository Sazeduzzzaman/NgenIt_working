...
@section('content')
    ...
    <div class="section_wp">
        ...
        <div class="container mb-5">
            ...
            <div class="nasted_tabbar_title">
                <div class="Hardware_feature_title">
                    <h1 class="text-center p-3">Hardware Products List</h1>
                </div>
                <p class="home_title_text">See how we’ve helped organizations of all sizes <span
                        class="font-weight-bold">across every industry</span><br>
    ...
    <section class="container mt-3 mb-5">
        <div class="Hardware_feature_title pb-5">
        ...
        <div class="row d-flex justify-content-start align-items-center">
            ...
            <div class="col-lg-6 col-sm-6">
                ...
                <div class="home_title">
                    <h5 class="home_title_heading" style="text-align: left;"> Areas of expertise
                    </h5>

                    <p class="home_title_text" style="text-align: left;">We’ll help you navigate today’s
                        ever-changing business environment with teams of technical experts and decades of industry
                        experience.</p>
                            ...
                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-6 col-sm-12">
                                        <h5 class="home_title_heading" style="text-align: left;">Healthcare
                                        </h5>
            ...
            <div class="global_call_section_content">
                <div class="home_title" style="width: 100%; margin: 0px;">
                    <h5 class="home_title_heading" style="text-align: left; color: #fff;"> <span>O</span>ur areas of
                        expertise</h5>
                    <p class="home_title_text text-white" style="text-align: left;">Turn ideas into powerful business
                        outcomes quickly and smoothly. Our solution architects and
        ...
        <div class="container">
            <div class="solution_number_wrapper">
                ...
                <h5 class="home_title_heading" style="text-align: left;">
                    <div class="Hardware_feature_title">
                        <h1 class="text-center pb-3"><span>T</span>echnology
                            Solutions</h1>
                    </div>
                </h5>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="tech_solution_item">
                        ...
                        <p class="tech_solution_text">hardware, Hardware & cloud partners</p>
    ...
    <div class="container pb-5">
        ...
        <div class="clint_help_section_heading_wrapper">
            ...
            <h5 class="home_title_heading" style="text-align: left;">
                <h5 class="home_title_heading" style="text-align: left;">
                    <div class="Hardware_feature_title">
                        <h1 class="text-center pt-4 pb-4"><span>Ind</span>ustries we serve</h1>
                    </div>
                </h5>
                <p class="home_title_text"><span class="font-weight-bold">We offer breadth and depth </span>
                    combining deep industry expertise and technical skills <br> to connect you to the right IT solutions.
            ...
            <div class="row d-flex justify-content-center align-items-center">
                <div class="col-lg-5 col-sm-12">
                    <div class="thing_together_wrapper">
                        ...
                        <p>Billing & invoice: <span class="main_color">+88 01714243446</span><br>
                            Information and sales: <span class="main_color">sales@ngenitltd.com</span><br>
                            OneCall support: <span class="main_color">+88 01714243446</span><br>
                            Returns: <span class="main_color">(+88) 0258155838</span></p>
