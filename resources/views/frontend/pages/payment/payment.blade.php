                        ...
                        <thead class="pb-2">
                            <tr class="border-bottom">
                                ...
                                <th width="30%" style="border: none; text-align:right;">
                                    <a href="{{ route('client.orders') }}"> <h6 class="m-0 mb-2">Back To Your Order Details</h6></a>
                                </th>
                            </tr>
                                    ...
                                    <tbody>
                                        @foreach($order_items as $item)
                                            <tr class="no-border border-bottom">
                                                <td style="border:none;" width="70%">
                                                    ...
                                                    @endphp
                                                    <p><a href="{{ route('product.details',$slug) }}" class="text-heading">{{ $name }}</a></p></span>
                                        ...
                                        @endforeach
                                            <tr style="border:none;">
                                                <td style="border:none;" colspan="2"><h5 class="text-center mb-0"><strong>Total Amount to Pay :</strong></h5></td>
                                                <td style="border:none;"><h5 class="text-center mb-0"><strong>$ {{ $order->amount }}</strong></h5></td>
                                            </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3 mx-3">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="payment_slip" class="form-control" id="">
                                        </div>
                                    </div>
                                </div>
                            </div>
