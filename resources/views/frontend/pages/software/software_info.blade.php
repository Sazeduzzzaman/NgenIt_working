                                    ...
                                    <div class="buttons_style pt-3">
                                        <div class="container_btn">
                                            <a href="{{ route('category.html', $item->slug) }}"
                                                class="btns effect01"><span>Go</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="global_call_section_content">
                <div class="home_title" style="width: 100%; margin: 0px;">
                    ...
                    <p class="home_title_text text-white" style="text-align: left;">Turn ideas into powerful business
                        outcomes quickly and smoothly. Our solution architects and technical experts are ready to help you
                        achieve more with our Insight Intelligent Technology™ portfolio.</p>
