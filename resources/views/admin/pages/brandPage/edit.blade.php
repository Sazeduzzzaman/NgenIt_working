                                    ...
                                    <form method="post" action="{{ route('brandPage.update', $brandPage->id) }}"
                                        ...
                                        <div class="row border mb-1">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-lg-6">
                                                    <div class="col-sm-12">
                                                        <h6 class="mb-0">Banner Image <span class="text-danger">*</span>
                                                        </h6>
                                                    </div>
                                                    <div class="col-sm-10 text-secondary">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="row mb-3">
                                                        <div class="col-sm-12">
                                                            <h6 class="mb-0">Header <span class="text-danger">*</span>
                                                            </h6>
                                                        </div>
                                        ...
                                        <div class="row border mb-1">
                                            ...
                                            <div class="row mb-3 mt-2">
                                                ...
                                                <div class="form-group col-sm-8 text-secondary">
                                                    <label for="title">
                                                        <h6 class="text-center mb-1">Row One Title</h6>
                                                    </label>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="form-group col-sm-8 text-secondary">
                                                    <label for="header">
                                                        <h6 class="text-center mb-1">Row One Header</h6>
                                                    </label>
                                                    <textarea name="row_one_header" id="header" class="form-control" cols="30" rows="3">{{ $brandPage->row_one_header }}</textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row border mb-1">
                                            ...
                                            <div class="row mb-3 mt-2">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="col-sm-12">
                                                        <h6 class="mb-0">Row Six Image (More than 1800*1200) <span
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="form-group col-sm-8 text-secondary">
                                                    ...
                                                    <input type="text" name="row_six_title"
                                                        ...
                                                        value="{{ $brandPage->row_six_title }}" maxlength="255"
                                                        id="title" />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="form-group col-sm-8 text-secondary">
                                                    <label for="title">
                                                        <h6 class="mb-0">Row Six header </h6>
                                                    </label>
                                        ...
                                        <div class="row border mb-1">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="form-group col-sm-6 text-secondary">
                                                    <label for="title">
                                                        <h6 class="mb-0">Row Nine title </h6>
                                                    </label>
                                                    <input type="text" value="{{ $brandPage->row_nine_title }}"
                                                        name="row_nine_title" class="form-control maxlength"
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="form-group col-sm-6 text-secondary">
                                                    <label for="header">
                                                        <h6 class="mb-0">Row Nine header</h6>
                                                    </label>
                                                    <textarea name="row_nine_header" id="header" class="form-control" cols="30" rows="3">{{ $brandPage->row_nine_header }}</textarea>
                                                </div>
                                            </div>
                                        </div>
