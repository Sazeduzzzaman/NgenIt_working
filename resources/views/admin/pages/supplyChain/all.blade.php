                            ...
                            <div class="card">
                                <div class="business_cards ">
                                    <div class="d-flex justify-content-between">
                                        <span class="p-0 m-0  card_title main_text_color">Pending Drafts <i
                                                class="fa-light fa-arrow-right"></i></span>
                                        <p class="p-0 m-0 text-danger value" style="font-size: 30px">
                                            {{App\Models\Admin\Product::where('product_status' , 'sourcing')->where('action_status' , 'save')->count()}}
                                        </p>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col d-flex justify-content-between align-items-center">
                                            <span class="p-0 m-0  card_title">Today's</span>
                                        ...
                                        |
                                        <div class="col d-flex justify-content-between align-items-center">
                                            <span class="p-0 m-0  card_title">This Month's</span>
                                            <p class="p-0 m-0 main_text_color value" style="font-size: 30px">
                                                5
                                            </p>
                                        </div>
                                ...
                                <div class="business_cards " style="border-top: 0.5px solid #24739763;">
                                    <div class="d-flex justify-content-between">
                                        <span class="p-0 m-0  card_title main_text_color">Pending SAS <i
                                                class="fa-light fa-arrow-right"></i></span>
                                        <p class="p-0 m-0 main_text_color value" style="font-size: 30px">
                                ...
                                <div class="business_cards " style="border-top: 0.5px solid #24739763;">
                                    <div class="d-flex justify-content-between">
                                        <span class="p-0 m-0  card_title main_text_color">Pending Approval <i
                                                class="fa-light fa-arrow-right"></i></span>
                                        <p class="p-0 m-0 main_text_color value" style="font-size: 30px">
                                            <i class="fa-light fa-can-food"></i> <span>10%</span>
                                        </p>
                                        ...
                                        <div class=" align-self-center">
                                            <a href="{{ route('purchase.index') }}" class=" text-success nav-link cat-tab3">
                                                <span class="ms-2 icon_btn" style="font-weight: 800;"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title="Add Expense">
                                                    <i class="ph-plus icons_design"></i>
                                                </span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="d-flex mb-3 ">
                                        ...
                                        <div class=" align-self-center">
                                            <a href="{{ route('delivery.index') }}"
                                                class=" text-success nav-link cat-tab3">
                                                <span class="ms-2 icon_btn" style="font-weight: 800;"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title="Add Expense">
                                                    <i class="ph-plus icons_design"></i>
                                                </span>
