...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="content pt-2 w-75 mx-auto">
            ...
            <form method="post" action="{{ route('hardware-info-page.update', $hardwareInfoPage->id) }}">
                @csrf
                @method('PUT')
                <div class="card">
                    <!--Banner Section-->
                            ...
                            <div class="col">
                                ...
                                <div class="px-2 py-2 rounded bg-light">
                                    ...
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_four_sub_title" type="url" maxlength="250"
                                                class="form-control form-control-sm"
                                    ...
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_five_title" type="text" maxlength="250"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Hardware Row Five Title" value="{{ $hardwareInfoPage->row_five_title }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_five_short_description" type="text" maxlength="250"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Hardware Row Five Short Description" value="{{ $hardwareInfoPage->row_five_short_description }}">
                                        </div>
                                    </div>
                                </div>
