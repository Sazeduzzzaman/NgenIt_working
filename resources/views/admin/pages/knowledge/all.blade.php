                ...
                <div class="col-lg-12">
                    <div class="card mt-1">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-9">
                                    <h4 class="text-center">All knowledge</h4>
                                </div>
                                <div class="col-lg-3">
                                    <a href="{{ route('knowledge.create') }}" type="button"
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="js-tab1">
                                    <div id="table1" class="card cardT">
                                        <table class="datatable table table-bordered table-hover knowledgeDT">
                                            <thead>
                                                <tr>
                                                    <th width="8%">Sl No:</th>
                                                    <th width="12%">Type</th>
                                                ...
                                                @if ($knowledges)
                                                    @foreach ($knowledges as $key => $knowledge)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a
                                                                    href="{{ asset('storage/files/' . $knowledge->brochure) }}">Download
                                                                    PDF</a>
                                                            </td>
