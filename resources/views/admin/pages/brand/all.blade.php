...
@section('content')
    <div class="content-wrapper">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="" class="text-primary"
                                            data-bs-toggle="modal" data-bs-target="#brandEdit">
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title text-white">Add Brand Managements </h6>
        ...
        <div id="brandEdit" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title text-white">Add Brand Managements </h6>
                                ...
                                <div class="px-2 py-2 m-2 bg-light rounded">
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="title" class="form-control form-control-sm maxlength"
                                                maxlength="100" value="{{ $brand->title }}" />
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="row mb-1">
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="category" class="form-control form-control-sm select"
                                                data-placeholder="Chose category name" required>
                                                <option value="Top" {{ $brand->category == 'Top' ? 'selected' : '' }}>
                                                    Top
                                                </option>
