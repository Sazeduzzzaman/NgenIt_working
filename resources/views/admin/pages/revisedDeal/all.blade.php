                ...
                <div class="col-lg-12">
                    <div class="card mt-1">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-9">
                                    <h4 class="text-center">All Revised Deal</h4>
                                </div>
                                <div class="col-lg-3">
                                    <a href="{{ route('revised-deal.create') }}" type="button"
                                                ...
                                                @if ($revisedDeals)
                                                    @foreach ($revisedDeals as $key => $revisedDeal)
                                                        <tr>
                                                            ...
                                                            <td>{{ $revisedDeal->rfq_type }}</td>
                                                            <td>{{ $revisedDeal->message }}</td>
                                                            <td class="text-center">
                                                                <a href="{{ route('revised-deal.edit', [$revisedDeal->id]) }}"
                                                                    class="text-primary">
