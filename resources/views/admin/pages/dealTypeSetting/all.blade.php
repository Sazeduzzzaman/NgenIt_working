                    ...
                    <div class="card m-auto mb-2" style="width: 50%;">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <a data-bs-toggle="modal" data-bs-target="#add-deal-type" type="button"
                    ...
                    <div class="row">
                        <div class="content">
                            <div class="card m-auto" style="width: 50%;">
                                <div class="card-body">
                                    <table class="datatable table table-bordered text-center table-hover dealTypeSettingDT">
                                        <thead>
                                            <tr>
                                                ...
                                                @foreach ($dealTypeSettings as $key => $dealTypeSetting)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a data-bs-toggle="modal" data-bs-target="#update-deal-type-{{ $dealTypeSetting->id }}"
                                                                class="text-primary">
                                                            ...
                                                            <!---Add modal--->
                                                                <div id="update-deal-type-{{$dealTypeSetting->id}}" class="modal fade" tabindex="-1" style="display: none;" aria-hidden="true">
                                                                    <div class="modal-dialog modal-dialog-scrollable">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title">Edit Deal Type Value</h5>
