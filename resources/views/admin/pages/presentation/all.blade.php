                ...
                <div class="col-lg-12">
                    <div class="card mt-1">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-9">
                                    <h4 class="text-center">All Presentation</h4>
                                </div>
                                <div class="col-lg-3">
                                    <a href="{{ route('presentation.create') }}" type="button"
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="js-tab1">
                                    <div id="table1" class="card cardT">
                                        <table class="datatable table table-bordered table-hover presentationDT">
                                            <thead>
                                                <tr>
                                                    <th width="8%">Sl No:</th>
                                                    <th width="12%">Type</th>
                                                ...
                                                @if ($presentations)
                                                    @foreach ($presentations as $key => $presentation)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a
                                                                    href="{{ asset('storage/files/' . $presentation->presentation) }}">Download
                                                                    PDF</a>
                                                            </td>
