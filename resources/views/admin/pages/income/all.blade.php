    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                {{-- <form action="" class="form-validate-jquery-update" method="post" enctype="multipart/form-data">
                    <div id="modal_income_edit" class="modal fade" tabindex="-1">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title text-center">Edit Income Information</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                </div>
                                <div class="modal-body">
                                    <table class="table -xs table-borderless table-responsive">
