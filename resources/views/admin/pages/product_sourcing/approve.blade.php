            ...
            <div class="page-header-content d-lg-flex border-top">
                <div class="d-flex">
                    <div class="breadcrumb py-2">
                        ...
                        <span class="breadcrumb-item active">Product Managementssss</span>
                    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <a href="{{ route('product-sourcing.create') }}" type="button"
                            ...
                            @if ($products)
                                @foreach ($products as $key => $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->action_status == 'seek_approval')
                                                <span
                                                    class="badge rounded-pill bg-success">{{ $item->action_status }}</span>
                                            @else
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="javascript:void(0);" class="text-success" data-bs-toggle="modal"
                                                title="Approve As Product"
                                                data-bs-target="#approve_product_{{ $item->id }}">
                                                <i class="mi-check-circle"></i>
                                            </a>
                                            <!---Category Update modal--->
                                            <div id="approve_product_{{ $item->id }}" class="modal fade" tabindex="-1"
                                                style="display: none;" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            @php
                                                                $product = App\Models\Admin\Product::where('product_status', 'sourcing')
                                                                    ->where('id', $item->id)
                                                                    ->first();
                                                        ...
                                                        <div class="modal-body border br-7">
                                                            ...
                                                            <form method="post"
                                                                action="{{ route('product-approve.store', $product->slug) }}"
                                                                            ...
                                                                            <table
                                                                                ...
                                                                                <thead>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <th>
                                                                                            Sale Price : $
                                                                                            {{ $product_sas->sales_price }}
                                                                                            <input type="hidden"
                                                                                                name="price"
                                                                                                value="{{ $product_sas->sales_price }}">
                                                                                        </th>
                                                                                        <th>competetor one price : $
                                                                                            {{ $product->competetor_one_price }}
                                                                                        </th>
                                                                                        <th>competetor two price : $
                                                                                            {{ $product->competetor_two_price }}
                                                                                        </th>
                                                                                    </tr>
                                                                                </thead>
                                                                            </table>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12 text-secondary text-center">
                                                                        <button type="submit"
                                                                            class="btn btn-primary me-3">Approve &nbsp;
                                                                            <i class="me-2 ph-paper-plane-tilt"></i>
                                                                        </button>
                                                                        <a href="{{ route('sas.edit', [$sas->ref_code]) }}"
