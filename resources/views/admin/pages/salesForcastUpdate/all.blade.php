        ...
        <div class="content pt-0 w-75 mx-auto">
            <div class="d-flex align-items-center py-2">
                ...
                <div class="text-success nav-link cat-tab3"
                    ...
                    z-index: 999;
                    margin-bottom: -40px;">
                    <a href="{{ route('sales-forcast.create') }}">
                    ...
                    <div class="text-center" style="margin-left: 300px">
                        <h5 class="ms-1" style="color: #247297;">All Sales Forcast</h5>
                    </div>
                </div>
                {{-- Add Details End --}}
            </div>
            <div>
                <table class="table salesForcastDT table-bordered table-hover text-center">
                    <thead>
                        <tr>
                            <th width="10%">Id</th>
                            <th width="40%">Date</th>
