...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="content pt-0">
            ...
            <div>
                <table class="table bankingDT table-bordered table-hover datatable-highlight text-center ">
                    <thead>
                        <tr>
                            <th width="8%">SL</th>
                        ...
                        @if ($bankings)
                            @foreach ($bankings as $key => $banking)
                                <tr>
                                    ...
                                    <td>{{ $banking->region_id }}</td>
                                    <td>{{ $banking->country_id }}</td>
                                    <td>{{ $banking->month }}</td>
                                    <td>{{ $banking->date }}</td>
                                                                ...
                                                                <div class="row mt-2">
                                                                    ...
                                                                    <div class="col-lg-12 d-flex pt-1">
                                                                        ...
                                                                        <select name="country_id"
                                                                            ...
                                                                            data-container-css-class="select-sm"
                                                                            data-minimum-results-for-search="Infinity"
                                                                            data-placeholder="Chose  Country Id" required>
                                                                            <option></option>
                                                                    ...
                                                                    <div class="col-lg-12 d-flex pt-1">
                                                                        ...
                                                                        @endphp
                                                                        <label
                                                                            class="col-form-label col-lg-2 p-0 text-start text-black">Month</label>
                                                                    ...
                                                                    <div class="col-lg-12 d-flex pt-1">
                                                                        <label
                                                                            class="col-form-label col-lg-2 p-0 text-start text-black">Date</label>
                                                                    ...
                                                                    <div class="col-lg-12 d-flex pt-1">
                                                                        <label
                                                                            class="col-form-label col-lg-2 p-0 text-start text-black">Fiscal
                                                                            Year</label>
                                                                        <div class="input-group">
                                                                    ...
                                                                    <div class="col-lg-12 d-flex pt-1">
                                                                        <label
                                                                            class="col-form-label col-lg-2 p-0 text-start text-black">Bank
                                                                            Name</label>
                                                                        <div class="input-group">
                                                                    ...
                                                                    <div class="col-lg-12 d-flex pt-1">
                                                                        <label
                                                                            class="col-form-label col-lg-2 p-0 text-start text-black">Deposit</label>
                                                                        <div class="input-group">
                                                                    ...
                                                                    <div class="col-lg-12 d-flex pt-1">
                                                                        <label
                                                                            class="col-form-label col-lg-2 p-0 text-start text-black">
                                                                        </label>
                                                                        <div class="input-group">
                                                                            <input name="withdraw" type="text"
                                                                                maxlength="50"
                                                                                class="form-control form-control-sm"
                                                                                required>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-lg-12 d-flex pt-1">
                                                                        <label
                                                                            class="col-form-label col-lg-2 p-0 text-start text-black">Purpose</label>
                                                                        <div class="input-group">
                                                                    ...
                                                                    <div class="col-lg-12 d-flex pt-1">
                                                                        <label
                                                                            class="col-form-label col-lg-2 p-0 text-start text-black">Document</label>
                                                                        <div class="input-group">
                                                                    ...
                                                                    <div class="col-lg-12 d-flex pt-1">
                                                                        <label
                                                                            class="col-form-label col-lg-2 p-0 text-start text-black">Comment</label>
                                                                        <div class="input-group">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body p-0 px-2">
                        <form action="{{ route('banking.store') }}" method="post"
                            ...
                            <div class="row mt-2">
                                <div class="col-lg-12 d-flex pt-1">
                                    <label class="col-form-label col-lg-2 p-0 text-start text-black">Region
                                        Name</label>
                                ...
                                <div class="col-lg-12 d-flex pt-1">
                                    ...
                                    @endphp
                                    <label class="col-form-label col-lg-2 p-0 text-start text-black">Month</label>
                                ...
                                <div class="col-lg-12 d-flex pt-1">
                                    <label class="col-form-label col-lg-2 p-0 text-start text-black">Date</label>
                                    <div class="input-group">
                                ...
                                <div class="col-lg-12 d-flex pt-1">
                                    <label class="col-form-label col-lg-2 p-0 text-start text-black">Fiscal
                                        Year</label>
                                    <div class="input-group">
                                        <input name="fiscal_year" type="text"
                                ...
                                <div class="col-lg-12 d-flex pt-1">
                                    <label class="col-form-label col-lg-2 p-0 text-start text-black">Bank
                                        Name</label>
                                    <div class="input-group">
                                ...
                                <div class="col-lg-12 d-flex pt-1">
                                    <label class="col-form-label col-lg-2 p-0 text-start text-black">Deposit</label>
                                    <div class="input-group">
                                ...
                                <div class="col-lg-12 d-flex pt-1">
                                    <label class="col-form-label col-lg-2 p-0 text-start text-black">Withdraw</label>
                                    <div class="input-group">
                                ...
                                <div class="col-lg-12 d-flex pt-1">
                                    <label class="col-form-label col-lg-2 p-0 text-start text-black">Purpose</label>
                                    <div class="input-group">
                                ...
                                <div class="col-lg-12 d-flex pt-1">
                                    <label class="col-form-label col-lg-2 p-0 text-start text-black">Document</label>
                                    <div class="input-group">
