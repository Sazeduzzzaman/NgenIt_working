                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="" class="text-primary" data-bs-toggle="modal"
                                            data-bs-target="#editOfficeLocation">
                                        ...
                                        {{-- Edit Success Modal --}}
                                        <div id="editOfficeLocation" class="modal fade" tabindex="-1">
                                            <div class="modal-dialog modal-dialog-centered modal-sm">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h6 class="modal-title text-white">Edit Office Location</h6>
                        ...
                        <form method="post" action="{{ route('office-location.store') }}"
                            ...
                            <div class="container">
                                ...
                                <div class="row  mb-1">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="name" name="whatsapp_number" class="form-control form-control-sm"
                                            maxlength="100" placeholder="Enter Whatsapp Number" required />
                                    </div>
                                </div>
                                {{--  --}}
                                <div class="row  mb-1">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="name" name="zip_code" class="form-control form-control-sm"
                                            maxlength="100" placeholder="Enter Zip Code" required />
                                    </div>
                                </div>
                                {{--  --}}
                                <div class="row  mb-1">
                                ...
                                <div class="row  mb-1">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea name="address" placeholder="Enter Address" id="" class="form-control" cols="3" rows="2"></textarea>
                                    </div>
                                </div>
                                {{--  --}}
                            </div>
