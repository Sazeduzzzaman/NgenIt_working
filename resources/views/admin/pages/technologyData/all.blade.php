                ...
                <div class="col-lg-12">
                    <div class="card mt-1">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-9">
                                    <h4 class="text-center">All Technology Data</h4>
                                </div>


                                <div class="col-lg-3">
                                    <a href="{{ route('technology-data.create') }}" type="button"
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="js-tab1">
                                    <div id="table1" class="card cardT">
                                        ...
                                        <table class="datatable table table-bordered table-hover technologyDataDT">
                                            <thead>
                                                <tr>
                                                    <th>Sl No:</th>
                                                    <th>name</th>
                                                    ...
                                                    @foreach ($technologyDatas as $key => $technologyData)
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="{{ route('technology-data.edit', [$technologyData->id]) }}"
                                                                    class="text-primary">
