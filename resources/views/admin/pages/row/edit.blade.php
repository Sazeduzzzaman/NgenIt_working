                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="form-group col-sm-9 text-secondary">
                                                    <input type="text" name="btn_name" class="form-control maxlength"
                                                        maxlength="255" value="{{ $row->btn_name }}"/>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-sm-3">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="form-group col-sm-9 text-secondary">
                                                    <textarea class="form-control" name="description" id="long_desc" style=" font-size: 12px; font-weight: 500;">{!! $row->description !!}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-12 text-secondary">
                                                <textarea class="form-control" name="short_des" rows="30" id="common" style=" font-size: 12px; font-weight: 500;">{!! $row->short_des !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-sm-12 text-secondary">
                                                <input type="text" name="list_title" class="form-control maxlength"
                                                    maxlength="255" value="{{ $row->list_title }}"/>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-sm-12">
                                            ...
                                            <div class="form-group col-sm-12 text-secondary">
                                                <input type="text" name="list_one" class="form-control maxlength"
                                                    maxlength="255" value="{{ $row->list_one }}"/>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-sm-12">
                                            ...
                                            <div class="form-group col-sm-12 text-secondary">
                                                <input type="text" name="list_two" class="form-control maxlength"
                                                    maxlength="255" value="{{ $row->list_two }}"/>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-sm-12">
                                            ...
                                            <div class="form-group col-sm-12 text-secondary">
                                                <input type="text" name="list_three" class="form-control maxlength"
                                                    maxlength="255" value="{{ $row->list_three }}"/>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-sm-12">
                                            ...
                                            <div class="form-group col-sm-12 text-secondary">
                                                <input type="text" name="list_four" class="form-control maxlength"
                                                    maxlength="255" value="{{ $row->list_four }}"/>
                                            </div>
                                        </div>
