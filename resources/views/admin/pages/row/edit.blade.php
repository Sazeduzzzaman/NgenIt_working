            ...
            <div class="container-fluid mt-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center p-0">
                        ...
                        <div class="me-2">
                            <ul class="nav nav-tabs border-0">
                                <li class="nav-item ">
                                    <a href="#imageWithRowEdit" class=" nav-link active cat-tab1 p-1" data-bs-toggle="tab">
                                        <p class="m-0 p-1">
                                ...
                                <li class="nav-item">
                                    <a href="#rowWithListEdit" class=" nav-link cat-tab2 p-1 " data-bs-toggle="tab">
                                        <p class="m-0 p-1">
                ...
                <div class="row rounded mt-1 w-75 mx-auto">
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="imageWithRowEdit">
                            <div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show" id="rowWithListEdit">
                            <div>
