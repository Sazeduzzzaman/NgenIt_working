...
<style>
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
                ...
                <article class="card">
                    <header class="card-header text-center"> <h6 class="m-0 p-0">RFQ Code: {{$rfq_details->rfq_code}}</h6> </header>
                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            @if (!empty($sourcing->grand_total))
                                                <table class="table table-bordered" style="width: 100%;height: auto;">
                                                    <thead>
                                                        <tr class="expand-switch1" style="background: rgb(0, 0, 0); padding-top:8px;padding-bottom:8px;">
                                                            <th width="86%" colspan="4" class="text-white" style="border:none; font-size:18px !important; padding-top:8px !important;padding-bottom:8px !important;">
                                                                <i class="icon1 fa fa-plus mx-3"></i> Product Details</th>
                                                    ...
                                                    <tbody class="expand-div1 d-none">
                                                        ...
                                                        @foreach ($deal_products as $key => $item)
                                                            <tr>
                                                                <td>
                                                                    <a class="text-black" title="{{ $item->item_name }}">{{ Str::limit($item->item_name,28) }}</a>
                                                                </td>
                                                ...
                                                @if (($rfq_details->tax_status) == '1')
                                                    <table class="table table-bordered mt-2 expand-div1 d-none">
                                                            ...
                                                            <td class="text-center"
                                                                width="10%"> {{ $sourcing->tax }}%</td>
                                                            <td class="text-center"
                                                                width="10%"> $ {{ $sourcing->tax_sales }}</td>
                                                        </tr>
                                            ...
                                            @else
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody class="expand-div d-none">
                                                            ...
                                                            <tr>
                                                                <th><a href="javascript:void(0);" title="{{App\Models\Admin\Product::where('id' , $rfq_details->product_id)->value('name')}}">{{ Str::limit(App\Models\Admin\Product::where('id' , $rfq_details->product_id)->value('name'),28) }}</a></th>
                            ...
                            <div class="track">
                                ...
                                @if ($rfq_details->rfq_type == 'rfq')
                                    ...
                                    <div class="step
                                        ...
                                        <span class="text">@if ($rfq_details->status == 'rfq_created')
                                ...
                                <div class="step
                                    ...
                                    <span class="text">
                                        @if ($rfq_details->status == 'deal_created')
                                            <a href="{{ route('deal-sas.show',$rfq_details->rfq_code) }}" class="text-success mx-3 mx-3"
                                                title="Create SAS">
                                ...
                                <div class="step
                                    ...
                                    <span class="text">
                                        @if ($rfq_details->status == 'sas_created')
                                            <a href="{{ route('deal-sas.edit',$rfq_details->rfq_code) }}" class="text-info mx-2" title="Edit Sas">
                                                <i class="icon-pencil icon-1x"></i>
                                            </a>
                                            <a href="{{ route('dealsasapprove',$rfq_details->rfq_code) }}" class="text-warning mx-3 mx-3" title="Approve Sas">
                                ...
                                <div class="step {{ $rfq_details->status == 'proof_of_payment_uploaded' ? 'active' : ''  }}
                                    ">
                                    <span class="icon">
    ...
    <!---Deal Show modal--->
    <div id="show-deals-{{ $rfq_details->rfq_code }}" class="modal fade" tabindex="-1" style="display: none;" aria-hidden="true">
    ...
    <div id="assign-manager-{{ $rfq_details->rfq_code }}" class="modal fade"
                                ...
                                <div class="row">
                                    <table class="table table-bordered table-striped p-1">
                                        <thead>
                                            ...
                                            <tr>
                                                <th colspan="3">
                                                    <h6 class="text-center mb-0 pt-1 text-black">Product Name : {{App\Models\Admin\Product::where('id' , $rfq_details->product_id)->value('name')}}</h6>
                                                </th>
                                            </tr>
                                            <tr>
                                ...
                                <div class="row mt-2 p-2 text-center">
                                    ...
                                    <div class="col-12 Rfquser" style="display:none">
                                        <div class="row mb-3 p-2 border">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="col-sm-12">
                                                    <h6 class="mb-0 text-black">Sales Manager (Leader - L1) <span class="text-danger">*</span></h6>
                                                </div>
    ...
    <div id="quotation-send-{{ $rfq_details->rfq_code }}" class="modal fade"
        tabindex="-1" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="content">
                        ...
                        <div class="center d-none">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="regular" value="1" id="flexRadioDefault1" {{ $rfq_details->regular == '1' ? 'checked' : '' }}>
                                <label class="form-check-label" for="flexRadioDefault1">
                                Regular Discount
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="special" value="1" id="flexRadioDefault1" {{ $rfq_details->special == '1' ? 'checked' : '' }}>
                                <label class="form-check-label" for="flexRadioDefault1">
                                Special Discount
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="tax_status" value="1" id="flexRadioDefault1" {{ $rfq_details->tax_status == '1' ? 'checked' : '' }}>
                                <label class="form-check-label" for="flexRadioDefault1">
                                Tax / VAT
                                </label>
                            </div>
                                    ...
                                    <div class="m-auto" style="width:80%;">
                                        <div class="bg-dark mb-2">
                                            <table class="text-center table table-hover br-7">
                                                <thead>
                                                    <tr class="br-7">
                                                        <th class="text-white">RFQ Code :  {{ $rfq_details->rfq_code }}
    ...
    <!---Work Order Upload modal--->
        @if ($sourcing)
            <div id="Work-order-{{ $rfq_details->rfq_code }}" class="modal fade"
                tabindex="-1" style="display: none;" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body border br-7">
                            ...
                            <form method="post"
                                action="{{ route('work-order.upload', $rfq_details->rfq_code) }}"
                                enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row mb-3">
