            ...
            <div class="page-header-content d-lg-flex">
                <div class="d-flex">
                    <h4 class="page-title mb-0">
                        Ledger <span class="fw-normal">Income & Expense</span>
                    </h4>
            ...
            <div class="page-header-content d-lg-flex border-top">
                <div class="d-flex">
                    <div class="breadcrumb py-2">
                        ...
                        <a href="#" class="breadcrumb-item">Income </a>
        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <div class="col-lg-12 padding">
                    ...
                    <h3 class="text-center"> LEDGER BOOK - FY23 </h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 offset-lg-1 table-responsive padding"
                            ...
                            <table class="table table-xs table-bordered">
                                <thead>
                                    <tr class="bg-dark bg-opacity-75">
                ...
                <div class="card-body table-responsive">
                    ...
                    <ul class="nav nav-tabs mt-3" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="#js-February-tab" class="nav-link" data-bs-toggle="tab"
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="#js-September-tab" class="nav-link" data-bs-toggle="tab"
                                aria-selected="false" role="tab" tabindex="-1">
                                Sep
                            </a>
                        </li>
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="#js-October-tab" class="nav-link" data-bs-toggle="tab"
                                aria-selected="false" role="tab" tabindex="-1">
                                Oct
                            </a>
                        </li>
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="#js-November-tab" class="nav-link" data-bs-toggle="tab"
                                aria-selected="false" role="tab" tabindex="-1">
                                Nov
                            </a>
                        </li>
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="#js-December-tab" class="nav-link" data-bs-toggle="tab"
                                aria-selected="false" role="tab" tabindex="-1">
                                Dec
                            </a>
                        </li>
                    ...
                    <div class="tab-content table-responsive">
                        ...
                        <div class="tab-pane fade active show" id="js-January-tab" role="tabpanel">
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#salesIncome_item1">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                ...
                                <div id="salesIncome_item1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body table-responsive">
                                        ...
                                        <table
                                            class="table table-bordered table-xs datatable-basic  JanTabIncome">
                                            <thead>
                                                <tr class="text-center">
                                                    <th width="5%"> SL </th>
                                                    <th width="15%"> RFQ Name </th>
                                                    <th width="10%"> Date </th>
                                                    <th width="10%"> Month </th>
                                                    <th width="10%"> PO Reference </th>
                                                    <th width="10%"> Client Name </th>
                                                    <th width="10%"> Type </th>
                                                    <th width="10%"> Amount </th>
                                                    <th width="10%"> Received Value </th>
                                                    <th width="10%"> Action </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td class="text-left" width="5%">01</td>
                                                    <td class="text-center" width="15%">RFQ name</td>
                                                    <td class="text-left" width="10%">02-02-23</td>
                                                    <td class="text-center" width="10%">Jan</td>
                                                    <td class="text-center" width="10%">po Reference</td>
                                                    <td class="text-center" width="10%">Client</td>
                                                    <td class="text-center" width="10%">type</td>
                                                    <td class="text-center" width="10%">00.03</td>
                                                    <td class="text-center" width="10%">00.03</td>
                                                    <td class="text-center" width="10%">
                                                        <a href="#" class="text-primary" data-bs-toggle="modal"
                                                            data-bs-target="#modal_income_edit"><i
                                                                class="icon-pencil"></i> </a>

                                                        <a href="#" class="text-danger delete"><i
                                                                class="delete icon-trash"></i>
                                                        </a>
                                                    </td>
                                                </tr>
                                        ...
                                        <table class="table table-bordered table-xs datatable-basic JanTab1">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center">particulars 1</td>
                        ...
                        <div class="tab-pane fade" id="js-February-tab" role="tabpanel">
                            ...
                            <div>
                                ...
                                <div id="FebruarysalesIncome_item1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic FebIncomeTab">
                                            <thead>
                                                <tr class="text-center">
                                                    <th width="5%"> SL </th>
                                                    <th width="15%"> RFQ Name </th>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#February_Marketing_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Marketing
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#FebruaryConveyance_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Conveyance
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#FebruaryIncentives_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Incentives
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#FebruaryOutstanding_item"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Outstanding
                                    </h3>
                        ...
                        <div class="tab-pane fade" id="js-March-tab" role="tabpanel">
                            <div>
                                ...
                                <div id="MarchsalesIncome_item1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic MarIncomeTab">
                                            <thead>
                                                <tr class="text-center">
                                                    <th width="5%"> SL </th>
                                                    <th width="15%"> RFQ Name </th>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#March_office_rent_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Office Rent
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#March_utilitybills_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Utility Bills
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#March_servicebills_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Service Bills
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#March_Marketing_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Marketing
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#Marchremuneration_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Remuneration
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#MarchConveyance_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Conveyance
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#MarchStationaries_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Stationaries
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#MarchIncentives_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Incentives
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#MarchMD_Personal_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> MD Personal
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#MarchOutstanding_item"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Outstanding
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#MarchEntertainment_item"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Entertainment
                                    </h3>
                        ...
                        <div class="tab-pane fade" id="js-April-tab" role="tabpanel">
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#AprilsalesIncome_item1">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Sales/Income
                                    </h3>
                                </a>
                                <div id="AprilsalesIncome_item1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic AprIncomeTab">
                                            <thead>
                                                <tr class="text-center">
                                                    <th width="5%"> SL </th>
                                                    <th width="15%"> RFQ Name </th>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#April_office_rent_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Office Rent
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#April_utilitybills_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Utility Bills
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#April_servicebills_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Service Bills
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#April_Marketing_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Marketing
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#Aprilremuneration_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Remuneration
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#AprilConveyance_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Conveyance
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#AprilStationaries_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Stationaries
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#AprilIncentives_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Incentives
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#AprilMD_Personal_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> MD Personal
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#AprilOutstanding_item"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Outstanding
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#AprilEntertainment_item"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Entertainment
                                    </h3>
                        ...
                        <div class="tab-pane fade" id="js-May-tab" role="tabpanel">
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#MaysalesIncome_item1">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Sales/Income
                                    </h3>
                                </a>
                                <div id="MaysalesIncome_item1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic MayIncomeTab">
                                            <thead>
                                                <tr class="text-center">
                                                    <th width="5%"> SL </th>
                                                    <th width="15%"> RFQ Name </th>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#May_office_rent_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Office Rent
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#May_utilitybills_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Utility Bills
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#May_servicebills_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Service Bills
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#Mayremuneration_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Remuneration
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#MayStationaries_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Stationaries
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#MayEntertainment_item"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Entertainment
                                    </h3>
                        ...
                        <div class="tab-pane fade" id="js-June-tab" role="tabpanel">
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#JunesalesIncome_item1">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Sales/Income
                                    </h3>
                                </a>
                                <div id="JunesalesIncome_item1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic JunIncomeTab">
                                            <thead>
                                                <tr class="text-center">
                                                    <th width="5%"> SL </th>
                                                    <th width="15%"> RFQ Name </th>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#June_office_rent_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Office Rent
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#June_utilitybills_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Utility Bills
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#June_servicebills_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Service Bills
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#Juneremuneration_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Remuneration
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#JuneStationaries_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Stationaries
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#JuneMD_Personal_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> MD Personal
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#JuneEntertainment_item"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Entertainment
                                    </h3>
                        ...
                        <div class="tab-pane fade" id="js-July-tab" role="tabpanel">
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#JulysalesIncome_item1">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Sales/Income
                                    </h3>
                                </a>
                                <div id="JulysalesIncome_item1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic JulIncomeTab">
                                            <thead>
                                                <tr class="text-center">
                                                    <th width="5%"> SL </th>
                                                    <th width="15%"> RFQ Name </th>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#July_office_rent_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Office Rent
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#July_utilitybills_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Utility Bills
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#July_servicebills_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Service Bills
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#Julyremuneration_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Remuneration
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#JulyStationaries_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Stationaries
                                    </h3>
                            ...
                            <div>
                                ...
                                <div id="JulyGroceries_item1" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic    JulTab10">
                                            <thead>
                                                <tr class="text-center">
                                                    <th> SL </th>
                                                    <th> Particulars </th>
                            ...
                            <div>
                                ...
                                <div id="JulyoldDebts_item1" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic    JulTab11">
                                            <thead>
                                                <tr class="text-center">
                                                    <th> SL </th>
                                                    <th> Particulars </th>
                            ...
                            <div>
                                ...
                                <div id="JulyIncentives_item1" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic    JulTab12">
                                            <thead>
                                                <tr class="text-center">
                                                    <th> SL </th>
                                                    <th> Particulars </th>
                            ...
                            <div>
                                ...
                                <div id="July_Returns_item1" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic    JulTab13">
                                            <thead>
                                                <tr class="text-center">
                                                    <th> SL </th>
                                                    <th> Particulars </th>
                            ...
                            <div>
                                ...
                                <div id="JulyTenderSecurities_item1" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic    JulTab14">
                                            <thead>
                                                <tr class="text-center">
                                                    <th> SL </th>
                                                    <th> Particulars </th>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#JulyMD_Personal_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> MD Personal
                                    </h3>
                                ...
                                <div id="JulyMD_Personal_item1" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic    JulTab15">
                                            <thead>
                                                <tr class="text-center">
                                                    <th> SL </th>
                                                    <th> Particulars </th>
                            ...
                            <div>
                                ...
                                <div id="JulyOutstanding_item" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic    JulTab16">
                                            <thead>
                                                <tr class="text-center">
                                                    <th> SL </th>
                                                    <th> Particulars </th>
                            ...
                            <div>
                                ...
                                <div id="JulyTravelTour_item" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic    JulTab17">
                                            <thead>
                                                <tr class="text-center">
                                                    <th> SL </th>
                                                    <th> Particulars </th>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#JulyEntertainment_item"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Entertainment
                                    </h3>
                                ...
                                <div id="JulyEntertainment_item" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic    JulTab18">
                                            <thead>
                                                <tr class="text-center">
                                                    <th> SL </th>
                                                    <th> Particulars </th>
                        ...
                        <div class="tab-pane fade" id="js-August-tab" role="tabpanel">
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#AugustsalesIncome_item1">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Sales/Income
                                    </h3>
                                </a>
                                <div id="AugustsalesIncome_item1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic AugIncomeTab">
                                            <thead>
                                                <tr class="text-center">
                                                    <th width="5%"> SL </th>
                                                    <th width="15%"> RFQ Name </th>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#August_office_rent_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Office Rent
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#August_Marketing_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Marketing
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#Augustremuneration_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Remuneration
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#AugustConveyance_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Conveyance
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#AugustStationaries_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Stationaries
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#AugustGroceries_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Groceries
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#AugustIncentives_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Incentives
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#AugustMD_Personal_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> MD Personal
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#AugustOutstanding_item"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Outstanding
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#AugustTravelTour_item"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Travel / Tour
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#AugustEntertainment_item"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Entertainment
                                    </h3>
                        ...
                        <div class="tab-pane fade" id="js-September-tab" role="tabpanel">
                            ...
                            <div>
                                ...
                                <div id="SeptembersalesIncome_item1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic SepIncomeTab">
                                            <thead>
                                                <tr class="text-center">
                                                    <th width="5%"> SL </th>
                                                    <th width="15%"> RFQ Name </th>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#SeptemberPurchase_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Purchase
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#SeptemberGroceries_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Groceries
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#SeptemberoldDebts_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Old / Debts
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#September_Returns_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Returns
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#SeptemberTravelTour_item"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Travel / Tour
                                    </h3>
                        ...
                        <div class="tab-pane fade" id="js-October-tab" role="tabpanel">
                            ...
                            <div>
                                ...
                                <div id="OctobersalesIncome_item1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic OctIncomeTab">
                                            <thead>
                                                <tr class="text-center">
                                                    <th width="5%"> SL </th>
                                                    <th width="15%"> RFQ Name </th>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#OctoberPurchase_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Purchase
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#October_Marketing_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Marketing
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#OctoberConveyance_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Conveyance
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#OctoberGroceries_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Groceries
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#OctoberoldDebts_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Old / Debts
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#OctoberIncentives_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Incentives
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#October_Returns_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Returns
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#OctoberMD_Personal_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> MD Personal
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#OctoberOutstanding_item"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Outstanding
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#OctoberTravelTour_item"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Travel / Tour
                                    </h3>
                        ...
                        <div class="tab-pane fade" id="js-November-tab" role="tabpanel">
                            ...
                            <div>
                                ...
                                <div id="NovembersalesIncome_item1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic NovIncomeTab">
                                            <thead>
                                                <tr class="text-center">
                                                    <th width="5%"> SL </th>
                                                    <th width="15%"> RFQ Name </th>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#NovemberPurchase_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Purchase
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#November_Marketing_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Marketing
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#NovemberConveyance_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Conveyance
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#NovemberGroceries_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Groceries
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#NovemberoldDebts_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Old / Debts
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#NovemberIncentives_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Incentives
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#November_Returns_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Returns
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#NovemberOutstanding_item"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Outstanding
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#NovemberTravelTour_item"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Travel / Tour
                                    </h3>
                        ...
                        <div class="tab-pane fade" id="js-December-tab" role="tabpanel">
                            ...
                            <div>
                                ...
                                <div id="DecembersalesIncome_item1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <table
                                            class="table table-bordered table-xs datatable-basic DecIncomeTab">
                                            <thead>
                                                <tr class="text-center">
                                                    <th width="5%"> SL </th>
                                                    <th width="15%"> RFQ Name </th>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#DecemberPurchase_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Purchase
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#December_Marketing_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Marketing
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#DecemberConveyance_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Conveyance
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#DecemberGroceries_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Groceries
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#DecemberoldDebts_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Old / Debts
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#DecemberIncentives_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Incentives
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#December_Returns_item1"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Returns
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#DecemberOutstanding_item"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Outstanding
                                    </h3>
                            ...
                            <div>
                                <a href="#" data-bs-toggle="collapse" data-bs-target="#DecemberTravelTour_item"
                                    class="text-black">
                                    <h3 style="padding: 5px; background-color: #ddd; font-size: 13px;">
                                        <i class="icon-plus2 icon-1x"></i> Travel / Tour
                                    </h3>
