            ...
            <div class="page-header-content d-lg-flex border-top">
                <div class="d-flex">
                    <div class="breadcrumb py-2">
                        ...
                        <a href="{{ route('software-info-page.index') }}" class="breadcrumb-item">Site Content</a>
                                    ...
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="banner_title" maxlength="255" type="text"
                                                ...
                                                placeholder="Enter Software Banner Title" required>
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="banner_short_description" type="text"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Banner Short Description " required>
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="banner_btn_name" type="text" maxlength="255"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Banner Btn Name" required>
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                    ...
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_four_title" type="text" maxlength="255"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Row Four Title " required>
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_four_sub_title" type="text" maxlength="255"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Row Four Sub Title " required>
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_four_short_description" type="text"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Row Four Short Description " required>
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_four_video_link" type="url" maxlength="100"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Row Four Video Link" required>
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_four_btn_name" type="url" maxlength="250"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Row Four Btn Name" required>
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_four_btn_link" type="url" maxlength="250"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Row Four Btn Link" required>
                                        </div>
                                    </div>
                                    {{--  --}}
                                </div>
                                    ...
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_five_title" type="text" maxlength="250"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Row Five Title" required>
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_five_short_description" type="text" maxlength="250"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Row Five Short Description" required>
                                        </div>
                                    </div>
                                    {{--  --}}
                                </div>
                                    ...
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_six_title" type="text" maxlength="250"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Row Six Title" required>
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_six_short_description" type="text"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Row Six Short Description" required>
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_six_btn_name" type="text"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Row Six Btn Name" required>
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_six_btn_link" type="url"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Row Six Btn Link" required>
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_six_image" type="file"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Row Six Image">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_seven_title" type="text" maxlength="250"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Row Seven Title" required>
                                        </div>
                                    </div>
                                    {{--  --}}
                                </div>
                                    ...
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_eight_title" type="text" maxlength="250"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Row Eight Title " required>
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_eight_short_description" type="text" maxlength="250"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Software Row Eight Short Description" required>
                                        </div>
                                    </div>
                                    {{--  --}}
                                </div>
