                                    ...
                                    <form method="post" action="{{ route('salesYearTarget.update', $salesYearTarget->id) }}">
                                        ...
                                        <div class="row border mb-3 p-2">
                                            ...
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <div class="form-group col-sm-12 text-secondary">
                                                    <input type="text" value="{{ $salesYearTarget->year_target }}" name="year_target" class="form-control maxlength"
                                                    maxlength="100" />
                                                </div>
                                            </div>
                                            <div class="col-lg-3 mb-3">
                                        ...
                                        <div class="row border mb-3 p-2">
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <div class="form-group col-sm-12 text-secondary">
                                                    <input type="text" value="{{ $salesYearTarget->quarter_one_target }}"   name="quarter_one_target"
                                                        class="form-control maxlength" maxlength="100" />
                                                </div>
                                            </div>
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <div class="form-group col-sm-12 text-secondary">
                                                    <input type="text" value="{{ $salesYearTarget->quarter_two_target }}"   name="quarter_two_target"
                                                        class="form-control maxlength" maxlength="100" />
                                                </div>
                                            </div>
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <div class="form-group col-sm-12 text-secondary">
                                                    <input type="text" value="{{ $salesYearTarget->quarter_three_target }}" name="quarter_three_target"
                                                        class="form-control maxlength" maxlength="100" />
                                                </div>
                                            </div>
                                            <div class="col-lg-3 mb-3">
                                                ...
                                                <div class="form-group col-sm-12 text-secondary">
                                                    <input type="text" value="{{ $salesYearTarget->quarter_four_target }}"  name="quarter_four_target"
                                                        class="form-control maxlength" maxlength="100" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row border mb-3 p-2">
                                            <div class="col-lg-3">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="form-group col-sm-12 text-secondary">
                                                        <input type="text" value="{{ $salesYearTarget->january_target }}" name="january_target"
                                                            class="form-control maxlength" maxlength="100" />
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="form-group col-sm-12 text-secondary">
                                                        <input type="text" value="{{ $salesYearTarget->february_target }}" name="february_target"
                                                            class="form-control maxlength" maxlength="100" />
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="form-group col-sm-12 text-secondary">
                                                        <input type="text" value="{{ $salesYearTarget->march_target }}" name="march_target" class="form-control maxlength"
                                                            maxlength="100" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="form-group col-sm-12 text-secondary">
                                                        <input type="text" value="{{ $salesYearTarget->april_target }}" name="april_target" class="form-control maxlength"
                                                            maxlength="100" />
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="form-group col-sm-12 text-secondary">
                                                        <input type="text" value="{{ $salesYearTarget->may_target }}" name="may_target" class="form-control maxlength"
                                                            maxlength="100" />
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="form-group col-sm-12 text-secondary">
                                                        <input type="text" value="{{ $salesYearTarget->june_target }}" name="june_target" class="form-control maxlength"
                                                            maxlength="100" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="form-group col-sm-12 text-secondary">
                                                        <input type="text" value="{{ $salesYearTarget->july_target }}" name="july_target" class="form-control maxlength"
                                                            maxlength="100" />
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="form-group col-sm-12 text-secondary">
                                                        <input type="text" value="{{ $salesYearTarget->august_target }}" name="august_target" class="form-control maxlength"
                                                            maxlength="100" />
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="form-group col-sm-12 text-secondary">
                                                        <input type="text" value="{{ $salesYearTarget->september_target }}" name="september_target"
                                                            class="form-control maxlength" maxlength="100" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="form-group col-sm-12 text-secondary">
                                                        <input type="text" value="{{ $salesYearTarget->october_target }}" name="october_target"
                                                            class="form-control maxlength" maxlength="100" />
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="form-group col-sm-12 text-secondary">
                                                        <input type="text" value="{{ $salesYearTarget->november_target }}" name="november_target"
                                                            class="form-control maxlength" maxlength="100" />
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="form-group col-sm-12 text-secondary">
                                                        <input type="text" value="{{ $salesYearTarget->december_target }}" name="december_target"
                                                            class="form-control maxlength" maxlength="100" />
                                                    </div>
                                                </div>
                                            </div>
