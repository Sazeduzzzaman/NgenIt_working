                                    ...
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_one_btn_seven_name" type="text" maxlength="100"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Row One Btn Seven Name" required>
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_one_btn_seven_link" type="text" maxlength="100"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Row One Btn Seven Link">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_one_btn_seven_icon" type="text" maxlength="100"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Row One Btn Seven Icon">
                                        </div>
                                    </div>
                                    {{--  --}}
                                </div>
                                    ...
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_one_btn_eight_link" type="text" maxlength="100"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Row One Btn Eight Name ">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_one_btn_seven_link" type="text" maxlength="100"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Row One Btn Eight Link">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        ...
                                        <div class="input-group">
                                            <input name="row_one_btn_eight_icon" type="text" maxlength="100"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Row One Btn Eight Icon">
                                        </div>
                                    </div>
                                    {{--  --}}
                                </div>
