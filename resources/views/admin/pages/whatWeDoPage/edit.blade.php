            ...
            <div class="page-header-content d-lg-flex border-top">
                <div class="d-flex">
                    <div class="breadcrumb py-2">
                        ...
                        <a href="{{ route('what-we-do-page.index') }}" class="breadcrumb-item">Site Content</a>
                    ...
                    <div class="container">
                        <div class="row g-2 p-1">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                ...
                                <span class="mt-1 fw-bold text-info">Row One Btn Seven</span>
                                <div class="px-2 py-2 rounded bg-light">
                                    <div class="d-flex align-items-center pt-1">
                                        <label
                                            class="col-form-label label_style col-lg-2 p-0 text-start text-black label_style">Row
                                            One Btn Seven Name</label>
                                        <div class="input-group">
                                            <input name="row_one_btn_seven_name" type="text" maxlength="100"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Row One Btn Seven Name"  value="{{ $whatWeDoPage->row_one_btn_seven_name }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        <label
                                            class="col-form-label label_style col-lg-2 p-0 text-start text-black label_style">Row
                                            One Btn Seven Link</label>
                                        <div class="input-group">
                                            <input name="row_one_btn_seven_link" type="text" maxlength="100"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Row One Btn Seven Link" value="{{ $whatWeDoPage->row_one_btn_seven_link }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        <label
                                            class="col-form-label label_style col-lg-2 p-0 text-start text-black label_style">Row
                                            One Btn Seven Icon</label>
                                        <div class="input-group">
                                            <input name="row_one_btn_seven_icon" type="text" maxlength="100"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Row One Btn Seven Icon" value="{{ $whatWeDoPage->row_one_btn_seven_icon }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                </div>
                                <span class="mt-1 fw-bold text-info">Row One Btn Eight</span>
                                <div class="px-2 py-2 rounded bg-light">
                                    <div class="d-flex align-items-center pt-1">
                                        <label
                                            class="col-form-label label_style col-lg-2 p-0 text-start text-black label_style">Row
                                            One Btn Eight Name </label>
                                        <div class="input-group">
                                            <input name="row_one_btn_eight_link" type="text" maxlength="100"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Row One Btn Eight Name " value="{{ $whatWeDoPage->row_one_btn_eight_name }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        <label
                                            class="col-form-label label_style col-lg-2 p-0 text-start text-black label_style">Row
                                            One Btn Eight Link</label>
                                        <div class="input-group">
                                            <input name="row_one_btn_seven_link" type="text" maxlength="100"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Row One Btn Eight Link" value="{{ $whatWeDoPage->row_one_btn_eight_link }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="d-flex align-items-center pt-1">
                                        <label
                                            class="col-form-label label_style col-lg-2 p-0 text-start text-black label_style">Row
                                            One Btn Eight Icon</label>
                                        <div class="input-group">
                                            <input name="row_one_btn_eight_icon" type="text" maxlength="100"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Row One Btn Eight Icon" value="{{ $whatWeDoPage->row_one_btn_eight_icon }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                </div>
